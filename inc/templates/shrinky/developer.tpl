...
<head>
<meta charset="utf-8"/>
<title><?php echo $config['site_name']; ?> | developer API</title>
...
<?php echo $config['base_url']; ?>P
    ...
    &lt;/response&gt;
		...
		<br/><br/>
         <p>Copyright &copy; <?php echo $config['site_name']; ?> - Designed by <a target="_blank" href="http://www.morocco24.net" title="Maroc 24">Maroc 24</p>
</div>
</body>
</html>