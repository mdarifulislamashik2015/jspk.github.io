...
<head>
<meta charset="utf-8"/>
<title>Error ID | <?php echo $config['site_name']; ?></title>
<meta name="description" content="Error - free URL shortening and redirection service that can turn a long URL into a very short and easy to remember URL">
